...
const (
	LLMService_ProcessRequest_FullMethodName = "/v1.LLMService/ProcessRequest"
)
...
func (c *lLMServiceClient) ProcessRequest(ctx context.Context, in *LLMRequest, opts ...grpc.CallOption) (*LLMResponse, error) {
...
func (UnimplementedLLMServiceServer) ProcessRequest(context.Context, *LLMRequest) (*LLMResponse, error) {
...
func _LLMService_ProcessRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LLMServiceServer).ProcessRequest(ctx, req.(*LLMRequest))
	}
